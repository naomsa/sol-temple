...
/**
 * @title ERC721Upgradable
 * @author naomsa <https://twitter.com/naomsa666>
 * @notice A complete ERC721 upgradable implementation including metadata and enumerable
 * functions. Completely gas optimized and extensible. Must be deployed with Proxy.
 */
abstract contract ERC721Upgradable is Auth {
  /*         _           _            */
  /*        ( )_        ( )_          */
  /*    ___ | ,_)   _ _ | ,_)   __    */
  /*  /',__)| |   /'_` )| |   /'__`\  */
